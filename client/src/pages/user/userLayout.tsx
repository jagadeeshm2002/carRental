...
const UserLayout: React.FC = () => {
  ...
  const getActiveTab = () => {
    ...
    return path[path.length - 1]; // Gets the last segment of the path
  };
  ...
  const getLinkClass = (tab: string) => {
    const baseClass = "flex items-center p-2 rounded-md transition-colors duration-200";
        ...
        <nav className="flex-1 p-4">
          <ul className="space-y-2">
            <li>
              ...
              >
                <User className={`h-5 w-5 ${isActiveTab("dashboard") ? "text-blue-600" : "text-blue-500"}`} />
            ...
            <li>
              ...
              >
                <Package className={`h-5 w-5 ${isActiveTab("orders") ? "text-blue-600" : "text-blue-500"}`} />
            ...
            <li>
              ...
              >
                <Star className={`h-5 w-5 ${isActiveTab("favourites") ? "text-blue-600" : "text-blue-500"}`} />
            ...
            <li>
              ...
              >
                <MessageSquare className={`h-5 w-5 ${isActiveTab("reviews") ? "text-blue-600" : "text-blue-500"}`} />
